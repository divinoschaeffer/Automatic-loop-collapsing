...
static inline long int Ranking0(long int i, long int j, long int k,long int N) {
  ...
  if ((i<=N) && ((j>=0)) && (((j<=k) && (k<=i)))) {
    return (6L*(long int)k-3L*powl((long int)j,2L)+6L*(long int)i*(long int)j+3L*(long int)j+powl((long int)i,3L)+3L*powl((long int)i,2L)+2L*(long int)i+6L)/6L;
  }
...
static inline long int trahrhe_k0(long int pc, long int i, long int j, long int N) {
  ...
  long int k = floorl(creall((6.L*(long double)pc+3.L*cpowl((long double)j,2.L)-6.L*(long double)i*(long double)j-3.L*(long double)j-cpowl((long double)i,3.L)-3.L*cpowl((long double)i,2.L)-2.L*(long double)i-6.L)/6.L)+0.00000001);
  if ((i<=N) && ((j>=0)) && (((j<=k) && (k<=i)))) {
    return k;
  }
  }
