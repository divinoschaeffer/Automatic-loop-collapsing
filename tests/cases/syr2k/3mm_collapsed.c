		...
		DATA_TYPE POLYBENCH_2D(G,NI,NL,ni,nl))
{
  int i, j, k;
	...
	unsigned pc_0;
	unsigned upper_bound_0 = Ehrhart0(_PB_NI,_PB_NJ,_PB_NK,_PB_NL,_PB_NM);
	...
	for (pc_0 = 1; pc_0 <= upper_bound_0; pc_0++)
	{
		...
		{
			i = trahrhe_i0(pc_0,_PB_NI,_PB_NJ,_PB_NK,_PB_NL,_PB_NM);
			j = trahrhe_j0(pc_0,i,_PB_NI,_PB_NJ,_PB_NK,_PB_NL,_PB_NM);
			first_iteration_0 = 0;
		}
